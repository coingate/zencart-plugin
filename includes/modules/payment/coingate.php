...
class coingate extends base
{
  ...
  function install()
  {
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable test mode?', 'MODULE_PAYMENT_COINGATE_TEST', 'False', 'Do you wish to enable test payment mode?', '6', '1', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
